...
import BuildByDevelopers from "layouts/gru/components/BuildByDevelopers";
import WorkWithTheRockets from "layouts/gru/components/WorkWithTheRockets";
import Projects1 from "layouts/gru/components/Projects1";
...
function GRU() {
    ...
    const handleSubmit = () => {
        const url = 'http://localhost:5000/api/model/gru';
